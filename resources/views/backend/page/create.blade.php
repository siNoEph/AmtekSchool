    ...
    <div class="content">
		...
		<div class="panel panel-flat">
			<div class="panel-heading">
				<h5 class="panel-title">Create Page</h5>
			...
			<div class="panel-body">
				{!! Form::open(array('url' => '/adminpanel/pages', 'method' => 'POST', 'class'=>'form-horizontal', 'role'=>'form')) !!}
				
				<fieldset class="content-group">
                    <div class="form-group {{ $errors->has('page') ? 'has-error has-feedback' : '' }}">
                        <label class="control-label col-lg-2">Page</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="page" value="{{ old('page') }}" placeholder="Page">
                            @if ($errors->has('page'))
                    ...
                    <div class="form-group {{ $errors->has('text') ? 'has-error has-feedback' : '' }}">
                        <div class="col-lg-12">
			                <textarea id="textNewPage" name="text" placeholder="Keterangan Page">
								{!! old('text') !!}
							</textarea>
                            @if ($errors->has('text'))
                                <div class="form-control-feedback">
